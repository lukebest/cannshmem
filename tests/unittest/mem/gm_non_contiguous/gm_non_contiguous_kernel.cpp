...
#define PUT_NON_CONTIGUOUS_NUM_TEST(NAME, TYPE)                                                                                                          \
    extern "C" __global__ __aicore__ void put_##NAME##_non_contiguous_num_test(GM_ADDR gva, GM_ADDR dev, int repeat, int length, uint64_t config)        \
    {                                                                                                                                                    \
...
#define TEST_NON_CONTIGUOUS_PUT(NAME, TYPE)                                                                                                          \
    void test_##NAME##_non_contiguous_put(uint32_t block_dim, void* stream, uint64_t config, uint8_t* gva, uint8_t* dev, int repeat, int length)     \
    {                                                                                                                                                \
...
#define GET_NON_CONTIGUOUS_NUM_TEST(NAME,TYPE)                                                                                                       \
    extern "C" __global__ __aicore__ void get_##NAME##_non_contiguous_num_test(GM_ADDR gva, GM_ADDR dev, int repeat, int length, uint64_t config)    \
    {                                                                                                                                                \
...
#define TEST_NON_CONTIGUOUS_GET(NAME, TYPE)                                                                                                          \
    void test_##NAME##_non_contiguous_get(uint32_t block_dim, void* stream, uint64_t config, uint8_t* gva, uint8_t* dev, int repeat, int length)     \
    {                                                                                                                                                \
