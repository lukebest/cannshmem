...
#define SHMEM_GET_TYPENAME_MEM_DETAILED(NAME, TYPE)                                                                             \
     ...
     * @param pe                [in] PE number of the remote PE.                                                                \
     */                                                                                                                         \
    SHMEM_DEVICE void shmem_get_##NAME##_mem(__gm__ TYPE* dst, __gm__ TYPE* src, const non_contiguous_copy_param& copy_params, int32_t pe)         \
    {                                                                                                                           \
        /* ROCE */                                                                                                              \
        /* RDMA */                                                                                                              \
        /* MTE  */                                                                                                              \
...
#define SHMEM_GET_TYPENAME_MEM_TENSOR(NAME, TYPE)                                                                               \
    ...
    * @param pe                [in] PE number of the remote PE.                                                                 \
    */                                                                                                                          \
    SHMEM_DEVICE void shmem_get_##NAME##_mem(AscendC::GlobalTensor<TYPE> dst, AscendC::GlobalTensor<TYPE> src, uint32_t elem_size, int pe)   \
    {                                                                                                                           \
        /* ROCE */                                                                                                              \
        /* RDMA */                                                                                                              \
        /* MTE  */                                                                                                              \
...
#define SHMEM_GET_TYPENAME_MEM_TENSOR_DETAILED(NAME, TYPE)                                                                      \
     ...
     * @param pe                [in] PE number of the remote PE.                                                                \
     */                                                                                                                         \
    SHMEM_DEVICE void shmem_get_##NAME##_mem(AscendC::GlobalTensor<TYPE> dst, AscendC::GlobalTensor<TYPE> src, const non_contiguous_copy_param& copy_params, int pe)  \
    {                                                                                                                           \
        /* ROCE */                                                                                                              \
        /* RDMA */                                                                                                              \
        /* MTE  */                                                                                                              \
...
#define SHMEM_PUT_TYPENAME_MEM_DETAILED(NAME, TYPE)                                                                             \
     ...
     * @param pe                [in] PE number of the remote PE.                                                                \
     */                                                                                                                         \
    SHMEM_DEVICE void shmem_put_##NAME##_mem(__gm__ TYPE* dst, __gm__ TYPE* src, const non_contiguous_copy_param& copy_params, int32_t pe)        \
    {                                                                                                                           \
        /* ROCE */                                                                                                              \
        /* RDMA */                                                                                                              \
        /* MTE  */                                                                                                              \
...
#define SHMEM_PUT_TYPENAME_MEM_TENSOR(NAME, TYPE)                                                                               \
    ...
    * @param pe                [in] PE number of the remote PE.                                                                 \
    */                                                                                                                          \
    SHMEM_DEVICE void shmem_put_##NAME##_mem(AscendC::GlobalTensor<TYPE> dst, AscendC::GlobalTensor<TYPE> src, uint32_t elem_size, int pe)   \
    {                                                                                                                           \
        /* ROCE */                                                                                                              \
        /* RDMA */                                                                                                              \
        /* MTE  */                                                                                                              \
...
#define SHMEM_PUT_TYPENAME_MEM_TENSOR_DETAILED(NAME, TYPE)                                                                      \
     ...
     * @param pe                [in] PE number of the remote PE.                                                                \
     */                                                                                                                         \
    SHMEM_DEVICE void shmem_put_##NAME##_mem(AscendC::GlobalTensor<TYPE> dst, AscendC::GlobalTensor<TYPE> src, const non_contiguous_copy_param& copy_params, int pe)  \
    {                                                                                                                           \
        /* ROCE */                                                                                                              \
        /* RDMA */                                                                                                              \
        /* MTE  */                                                                                                              \
...
#define SHMEM_GET_TYPENAME_MEM_UB(NAME, TYPE)                                                                                   \
    /**                                                                                                                         \
     * @brief Synchronous interface. Copy contiguous data on symmetric memory from the specified PE to address on the local UB. \
     *                                                                                                                          \
     ...
     * @param pe                [in] PE number of the remote PE.                                                                \
     */                                                                                                                         \
    SHMEM_DEVICE void shmem_get_##NAME##_mem(__ubuf__ TYPE* dst, __gm__ TYPE* src, uint32_t elem_size, int pe)                  \
    {                                                                                                                           \
        /* ROCE */                                                                                                              \
        /* RDMA */                                                                                                              \
        /* MTE  */                                                                                                              \
...
#define SHMEM_GET_TYPENAME_MEM_UB_TENSOR(NAME, TYPE)                                                                            \
     ...
     * @param pe                [in] PE number of the remote PE.                                                                \
     */                                                                                                                         \
    SHMEM_DEVICE void shmem_get_##NAME##_mem(AscendC::LocalTensor<TYPE> dst, AscendC::GlobalTensor<TYPE> src, uint32_t elem_size, int pe)    \
    {                                                                                                                           \
        /* ROCE */                                                                                                              \
        /* RDMA */                                                                                                              \
        /* MTE  */                                                                                                              \
...
#define SHMEM_GET_TYPENAME_MEM_UB_DETAILED(NAME, TYPE)                                                                          \
     ...
     * @param pe                [in] PE number of the remote PE.                                                                \
     */                                                                                                                         \
    SHMEM_DEVICE void shmem_get_##NAME##_mem(__ubuf__ TYPE* dst, __gm__ TYPE* src, const non_contiguous_copy_param& copy_params, int pe) \
    {                                                                                                                           \
        /* ROCE */                                                                                                              \
        /* RDMA */                                                                                                              \
        /* MTE  */                                                                                                              \
...
#define SHMEM_GET_TYPENAME_MEM_UB_TENSOR_DETAILED(NAME, TYPE)                                                                   \
     ...
     * @param pe                [in] PE number of the remote PE.                                                                \
     */                                                                                                                         \
    SHMEM_DEVICE void shmem_get_##NAME##_mem(AscendC::LocalTensor<TYPE> dst, AscendC::GlobalTensor<TYPE> src, const non_contiguous_copy_param& copy_params, int pe)  \
    {                                                                                                                           \
        /* ROCE */                                                                                                              \
        /* RDMA */                                                                                                              \
        /* MTE  */                                                                                                              \
...
#define SHMEM_PUT_TYPENAME_MEM_UB(NAME, TYPE)                                                                                   \
    ...
    * @param pe                [in] PE number of the remote PE.                                                                 \
    */                                                                                                                          \
    SHMEM_DEVICE void shmem_put_##NAME##_mem(__gm__ TYPE* dst, __ubuf__ TYPE* src, uint32_t elem_size, int32_t pe)              \
    {                                                                                                                           \
        /* ROCE */                                                                                                              \
        /* RDMA */                                                                                                              \
        /* MTE  */                                                                                                              \
...
#define SHMEM_PUT_TYPENAME_MEM_UB_TENSOR(NAME, TYPE)                                                                            \
    ...
    * @param pe                [in] PE number of the remote PE.                                                                 \
    */                                                                                                                          \
    SHMEM_DEVICE void shmem_put_##NAME##_mem(AscendC::GlobalTensor<TYPE> dst, AscendC::LocalTensor<TYPE> src, uint32_t elem_size, int32_t pe)    \
    {                                                                                                                           \
        /* ROCE */                                                                                                              \
        /* RDMA */                                                                                                              \
        /* MTE  */                                                                                                              \
...
#define SHMEM_PUT_TYPENAME_MEM_UB_DETAILED(NAME, TYPE)                                                                          \
    ...
    * @param pe                [in] PE number of the remote PE.                                                                 \
    */                                                                                                                          \
    SHMEM_DEVICE void shmem_put_##NAME##_mem(__gm__ TYPE* dst, __ubuf__ TYPE* src, const non_contiguous_copy_param& copy_params, int32_t pe) \
    {                                                                                                                           \
        /* ROCE */                                                                                                              \
        /* RDMA */                                                                                                              \
        /* MTE  */                                                                                                              \
...
#define SHMEM_PUT_TYPENAME_MEM_UB_TENSOR_DETAILED(NAME, TYPE)                                                                   \
    ...
    * @param pe                [in] PE number of the remote PE.                                                                 \
    */                                                                                                                          \
    SHMEM_DEVICE void shmem_put_##NAME##_mem(AscendC::GlobalTensor<TYPE> dst, AscendC::LocalTensor<TYPE> src, const non_contiguous_copy_param& copy_params, int32_t pe)  \
    {                                                                                                                           \
        /* ROCE */                                                                                                              \
        /* RDMA */                                                                                                              \
        /* MTE  */                                                                                                              \
